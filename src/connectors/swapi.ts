...
export default class SWAPIConnector {
  ...
  public getConnections(urls: string[]) {
    return this.loader.loadMany(urls)
  }

  public fetchPageForResource(resource: string) {
    return (offset?: number, limit?: number) => this.fetchPage(resource, offset, limit)
  }
